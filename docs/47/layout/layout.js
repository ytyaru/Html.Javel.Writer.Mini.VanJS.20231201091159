...
class SingleScreen {
    constructor() {
        ...
        //this._div = van.tags.div({onwheel:(e)=>this.#onWheel(e), style:()=>`padding:0;margin:0;overflow-y:scroll;width:${this._w.val};height:${this._h.val};box-sizing:border-box;border:${this._border.val};writing-mode:${this._writingMode.val};overflow-x:${this._overflowX.val};overflow-y:${this._overflowY.val};text-orientation:${this._textOrient.val};word-break:${this._wordBreak.val};`}, ()=>div(this.children))
        //this._div = van.tags.div({onwheel:(e)=>this.#onWheel(e), style:()=>`padding:0;margin:0;overflow-y:scroll;width:${this._w.val};height:${this._h.val};box-sizing:border-box;border:${this._border.val};writing-mode:${this._writingMode.val};overflow-x:${this._overflowX.val};overflow-y:${this._overflowY.val};text-orientation:${this._textOrient.val};word-break:${this._wordBreak.val};`}, ...this.children)
        //this._div = van.tags.div({onwheel:(e)=>this.#onWheel(e), style:()=>`padding:0;margin:0;overflow-y:scroll;width:${this._w.val};height:${this._h.val};box-sizing:border-box;border:${this._border.val};writing-mode:${this._writingMode.val};overflow-x:${this._overflowX.val};overflow-y:${this._overflowY.val};text-orientation:${this._textOrient.val};word-break:${this._wordBreak.val};`}, ()=>div({width:"100%", height:"100%"}, this.children))
        //this._div = van.tags.div({onwheel:(e)=>this.#onWheel(e), style:()=>`padding:0;margin:0;overflow-y:scroll;width:${this._w.val};height:${this._h.val};box-sizing:border-box;border:${this._border.val};writing-mode:${this._writingMode.val};overflow-x:${this._overflowX.val};overflow-y:${this._overflowY.val};text-orientation:${this._textOrient.val};word-break:${this._wordBreak.val};`}, ()=>div({width:"inherit", height:"inherit"}, this.children))
        //this._div = van.tags.div({onwheel:(e)=>this.#onWheel(e), style:()=>`padding:0;margin:0;overflow-y:scroll;width:${this._w.val};height:${this._h.val};box-sizing:border-box;border:${this._border.val};writing-mode:${this._writingMode.val};overflow-x:${this._overflowX.val};overflow-y:${this._overflowY.val};text-orientation:${this._textOrient.val};word-break:${this._wordBreak.val};`}, ()=>this.children)
...
class TripleScreen {
    constructor() {
        ...
        //this._div = van.tags.div({style:()=>`padding:0;margin:0;box-sizing:border-box;display:grid;grid-template-columns:${this._gridTemplateColumns.val};grid-template-rows:${this._gridTemplateRows.val};`}, ()=>((Type.isEl(this._left)) ? this._left : this._left.el), ()=>((Type.isEl(this._center)) ? this._center : this._center.el), ()=>((Type.isEl(this._right)) ? this._right : this._right.el))
        //this._div = van.tags.div({style:()=>`padding:0;margin:0;box-sizing:border-box;display:grid;grid-template-columns:${this._gridTemplateColumns.val};grid-template-rows:${this._gridTemplateRows.val};`}, ()=>{console.log(this._left);return ((Type.isEl(this._left)) ? this._left : this._left.el)}, ()=>((Type.isEl(this._center)) ? this._center : this._center.el), ()=>((Type.isEl(this._right)) ? this._right : this._right.el))
    }
    get el() { return this._div }
    get left() { return this._left }
    get right() { return this._right }
    get center() { return this._center }
//    set left(v) { if (Type.isEl(v)) { console.log('leftttttttttttttt'); this._left = v } }
//    set right(v) { if (Type.isEl(v)) { this._right = v } }
//    set center(v) { if (Type.isEl(v)) { this._center = v } }
    resize() {
